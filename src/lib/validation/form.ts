...
const schemaFormValidator = z.object({
    ...
    message : z.string().min(5, {message : "Message must be at least 5 characters long"}).max(500, {message : "Message must be at most 500 characters long"}),
})

export type FormValue = z.infer<typeof schemaFormValidator>