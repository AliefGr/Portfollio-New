...
import { Spotlightt } from './spotlight';

const GradientBackground = ({ children }: { children: React.ReactNode }) => {
  return (
    <div className="w-full relative min-h-screen overflow-hidden">
      <div className="h-screen absolute z-0 w-full overflow-hidden">
        <AnimatedGrid
          numSquares={15}
          maxOpacity={0.1}
          duration={6}
        ...
        <div className="bg-gradient-to-t from-black z-20 h-3/4 w-full absolute inset-x-0 top-[60% top-[10%]"></div>
